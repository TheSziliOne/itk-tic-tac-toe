...
# Template: app
# Command: C:\Qt\6.4.0\mingw_64\bin\qmake.exe -o Makefile GraphicsKitQt.pro -spec win32-g++ "CONFIG+=debug" "CONFIG+=qml_debug"
#############################################################################
...
Makefile: GraphicsKitQt.pro C:/Qt/6.4.0/mingw_64/mkspecs/win32-g++/qmake.conf C:/Qt/6.4.0/mingw_64/mkspecs/features/spec_pre.prf \
		...
		C:/Qt/6.4.0/mingw_64/mkspecs/features/win32/console.prf \
